...
> [!WARNING]
> This might be the limit of Google Colab where you can only rent a **single** GPU. You may have to move on to GPU clusters at this point. You can't increase per-device-batch, or add more transformer layers, or increase gradient accumilation on a Google Colab NVIDIA A100 which has `40` GB GPU RAM.
